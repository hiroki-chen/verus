...
core::arch::global_asm!(include_str!("../asm/idt.S"), options(att_syntax));

// This is auto-generated by `build.rs`.
core::arch::global_asm!(include_str!("../asm/idt_gen.S"), options(att_syntax));
...
pub fn init_global_idt() {
    ...
    crate::imp::doorbell::HVDoorbell::init_hv_doorbell_addr();
}
