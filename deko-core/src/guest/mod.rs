...
pub use protocol::{
    ...
    DEKO_SERVICE_EXTEND_LOAD_POLICY, DEKO_SERVICE_EXTEND_MAP_IFC,
    ...
    DEKO_SERVICE_EXTEND_TIMER_EVENT, DEKO_SERVICE_PVALIDATE, DEKO_SERVICE_QUERY_PROTOCOL,
    DEKO_SERVICE_REMAP_CA, DEKO_SERVICE_TIMER, DEKO_SERVICE_WITHDRAW_MEMORY,
};
